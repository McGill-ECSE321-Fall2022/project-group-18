...
| --- | --- | ---------- |
| Andrei Sandor | 14  | Implemented the donation and hiring/firing employees tabs, worked on the wiki. Updated some endpoints that are tested to help me to complete the interactions required for the hiring/firing employee tab |
