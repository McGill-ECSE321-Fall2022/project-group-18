...
//        testArtifactList.add(testArtifact2);
    ...
    @Test
    public void testGetAllCustomerLoans() {
...
//        testArtifactList.add(testArtifact2);
        ...
        when(customerRepository.findAll()).thenAnswer((InvocationOnMock invocation) -> allCustomerList);

        Map<String, Integer> allCustomersLoans = loanService.getAllCustomerLoans();
        assertNotNull(allCustomersLoans);
        assertEquals(customer.getAccountID(), allCustomersLoans.get(Integer.toString(requestID)));
    }
